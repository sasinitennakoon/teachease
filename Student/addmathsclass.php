...
<a href='maths.php'><button>Go to Dashboard</button></a>
    <div class="content">
            ...
            <div class="panel10">
                ...
                <table>
                    ...
                    <?php
                        ...
                        $query = mysqli_query($link,"select * from schedule WHERE subject_id = '9'") or die(mysqli_error($link));
...
if (isset($_POST['leave'])) {
    ...
    ?>
    <script>
    window.location = 'addmathsclass.php';
    </script> 
<?php
}
