...
<a href='science.php'><button>Go to Dashboard</button></a>
    <div class="content">
            ...
            <div class="panel10">
                ...
                <table>
                    ...
                    <?php
                        ...
                        $query = mysqli_query($link,"select * from schedule WHERE subject_id = '14'") or die(mysqli_error($link));
...
if (isset($_POST['leave'])) {
    ...
    ?>
    <script>
    window.location = 'addscienceclass.php';
    </script> 
<?php
}
