...
<div class="content">
    ...
    <?php
					...
					if($count <= 0)
					{
						echo "<b>Currently you have not registered for any Maths classes</b>";
					}
					else
					{?>
                    <div class="panels1">
    ...
    <?php
				...
				?>
                        ...
                        <div class="but">
                            ...
                            <a href="addmathsclass.php" style='text-decoration:none;color:white;'>
                                <i class="fa fa-fw fa-plus"></i>&nbsp;Add Maths Class</a>
                            </button>
