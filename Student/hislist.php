...
$sql = "SELECT * FROM scienceflashcrd_bundle WHERE subject = 'History' AND user_id = '$userId'";
...
<head>
    ...
    <title>History Flashcard Bundles</title>
        ...
        <table id="flashcardTable">
            ...
            <tbody>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<tr><td colspan='3'>No History flashcard bundles found.</td></tr>";
                }
                ?>
            </tbody>
        </table>
