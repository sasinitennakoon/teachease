...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["share"])) {
    ...
    $subject = "History"; // You can customize this
    ...
    <div id="confirmationModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-section">
                <h4>Your Subject:</h4>
                <input type="text" id="flashCardSubject" value="History" readonly> <!-- Display the subject as "Science" with readonly attribute -->
            </div>
            <div class="modal-section">
