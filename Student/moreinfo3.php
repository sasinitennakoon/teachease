...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '14' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '9' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '12' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '16' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '15' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
...
<?php
   $studentMarks = [];
        $query = mysqli_query($link,"select * from marks where term_id = '3' AND subject_id = '11' ");
        while($row = mysqli_fetch_array($query))
        {
            $mar = $row['marks'];
