...
<a href='sinhala.php'><button>Go to Dashboard</button></a>
    <div class="content">
            ...
            <div class="panel10">
                ...
                <table>
                    ...
                    <?php
                        ...
                        $query = mysqli_query($link,"select * from schedule WHERE subject_id = '16'") or die(mysqli_error($link));
...
if (isset($_POST['leave'])) {
    ...
    ?>
    <script>
    window.location = 'addsinhalaclass.php';
    </script> 
<?php
}
