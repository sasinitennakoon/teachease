       ...
       <?php
				...
				?>
                        ...
                        <tr>
                            ...
                            <td><div class="but"><button class="btn btn-info"><a href="sciencemate.php?schedule_id=<?php echo $row['schedule_id']?>;" style='text-decoration:none;color:white;'>View Study material</a></button></td>
                        </tr>
                    </tbody>
