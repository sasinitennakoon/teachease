    ...
    // Validation error flag
      $errflag = false;
        ...
        if ($errflag) {
            ...
            $sql = mysqli_query($link,"update student set firstname='$firstname',lastname='$lastname',password='$password',grade='$grade',language='$language',image='$target_file' where student_id='$session_id'") or die(mysqli_error($link));
  ...
  <?php echo "<img src='" . $row['image'] . "' id='output' width='200' />"; ?>
          ...
          <div class="user-details">
            ...
            <div class='input-box'>
                ...
                <select id="grade" name="grade" class="select" value="<?php echo $row['grade']; ?>">
