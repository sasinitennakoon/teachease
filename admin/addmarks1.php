...
if (isset($_POST['save'])) {
    ...
    mysqli_query($link, "INSERT INTO marks (student_id, subject_id, term_id, marks) VALUES ('$student_id', '14', '1', '$science')") or die(mysqli_error($link));
    ...
    echo "<script>window.location = 'term1.php';</script>";
}
?>
