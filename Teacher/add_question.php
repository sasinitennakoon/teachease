                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                            ...
                            <div class="gender-details">
								A: <input type="text" name="ans1" size="60"> <input name="answer" value="A" type="radio" id="dot-1">
                                <div class="category">
                                    <label for="dot-1">
                                    <span class="dot one"></span>
                                    <span class="gender"></span></label>
                                </div><br><br>
								B: <input type="text" name="ans2" size="60"> <input name="answer" value="B" type="radio" id="dot-2">
                                <div class="category">
                                    <label for="dot-2">
                                    <span class="dot two"></span>
                                    <span class="gender"></span></label>
                                </div><br><br>
								C: <input type="text" name="ans3" size="60"> <input name="answer" value="C" type="radio" id="dot-3">
                                <div class="category">
                                    <label for="dot-3">
                                    <span class="dot three"></span>
                                    <span class="gender"></span></label>
                                </div><br><br>
								D: <input type="text" name="ans4" size="60"> <input name="answer" value="D" type="radio" id="dot-4">
                                <div class="category">
                                    <label for="dot-4">
							...
							<div id="opt12">
								...
								<input name="correctt"  value="False" type="radio">False<br /><br /> -->
                                 <div class="gender-details">
                                <input type="radio" name="gender" value="true" id="dot-1">
                                <input type="radio" name="gender" value="false" id="dot-2">
                                <span class="gender-title">Gender</span>
                                <div class="category">
                                    <label for="dot-1">
                                    <span class="dot one"></span>
                                    <span class="gender">True</span>
                                    </label>
                                    <label for="dot-2">
                                    <span class="dot two"></span>
                                    <span class="gender">False</span>
                                    </label>
                                </div>
                                </div> 
							</div>
