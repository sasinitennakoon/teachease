...
<body>
            ...
            <?php
                $query = mysqli_query($link,"select * from files where file_id = '$get_id'")or die(mysqli_error());
                $row = mysqli_fetch_array($query);
			?>
            ...
            <div class="panel10">
                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="name" placeholder="Enter File name" value="<?php echo $row['fname']; ?>" required>
                    </div>

                    <div class="input-box">
                        <span class="details">Description</span>
                        <input type="text" name="desc" placeholder="Enter Description" value="<?php echo $row['fdesc']; ?>" required>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <select name="class_id" required>
                            <?php
                             ...
                             ?>
							<option value="<?php echo $row['class_id']; ?>" ></option>
								<?php
...
if(isset($_POST['update'])) {
    ...
    if ($errflag) {
        ...
        if (move_uploaded_file($uploaded_file['tmp_name'], $target_file)) {
            ...
            mysqli_query($link, "update files set fdesc='$filedesc', floc='$target_file', fdatein= NOW(), class_id='$class_id', fname='$name', uploaded_by='$uploaded_by'
                                where file_id='$get_id'") 
